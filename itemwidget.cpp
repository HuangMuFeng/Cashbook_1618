...
#include<QString>
#include<QCheckBox>
itemWidget::itemWidget(int money,QString typeName,QString content,QString time,QWidget *parent) : QWidget(parent)
{
    ...
    itemLayout->addWidget(itemLabel4);
